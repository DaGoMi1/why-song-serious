...
import { Music, Sparkles, BarChart3, ListMusic } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full md:w-auto bg-[#1DB954] hover:bg-[#1ed760] text-white py-4 px-8 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 flex items-center justify-center gap-3"
              >
